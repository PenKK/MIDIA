...
public class DAWApp {
    ...
    // MODIFIES: block
    // EFFECTS: creates new note in a block, prompts for the appropriate parameters, and then returns the created notes index
    public int createNewNote(Block block, int pitch, int velocity, long startTick, long durationTicks) {
        return 0; //stub
    }

    // MODIFIES: block
    // EFFECTS: prompts the user to modify (and pottenally delete) a notes pitch, velocity, startTick, and duration by prompted index
